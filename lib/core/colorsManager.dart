...
//   // بيج مريح بدل السماوي
//   scaffoldBackgroundColor: const Color(0xFFF6EFE4),

//   // أبيض نضيف عشان الكارد يبان
//   cardColor: Colors.white,

//   // --- الأيقونات ---
//   iconTheme: const IconThemeData(
//     color: Color(0xFF0B1220), // كحلي غامق
//     size: 24,
//   ),
...
//   elevatedButtonTheme: ElevatedButtonThemeData(
//     style: ElevatedButton.styleFrom(
//       backgroundColor: const Color(0xFF5B7BD5), // أزرق لبني مريح
//       foregroundColor: Colors.white,
//       textStyle: const TextStyle(
//         fontFamily: "Cairo",
//         fontWeight: FontWeight.bold,
...
//   // AppBar كحلي + دهبي = فخامة
//   appBarTheme: const AppBarTheme(
//     backgroundColor: Color(0xFF0B1220),
//     foregroundColor: Color(0xFFD4AF37), // دهبي
//     elevation: 0,
//   ),

//   bottomNavigationBarTheme: const BottomNavigationBarThemeData(
//     backgroundColor: Colors.white,
//     selectedItemColor: Color(0xFF5B7BD5), // أزرق
//     unselectedItemColor: Color(0xFF7A869A),
//     showUnselectedLabels: true,
//     selectedLabelStyle: TextStyle(
//       fontFamily: "Cairo",
//       fontWeight: FontWeight.bold,
...
//   colorScheme: const ColorScheme.light(
//     primary: Color(0xFF5B7BD5), // الأزرق الأساسي
//     onPrimary: Color(0xFFFFFFFF),

//     secondary: Color(0xFFD4AF37), // دهبي
...
//     selectedItemColor: Color(0xFF5B7BD5),
